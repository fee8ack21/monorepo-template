<template>
  <div class="container mx-auto py-6">
    ...
    <div class="py-3 mb-6 text-center bg-primary-500">Home Page Custom Content</div>
    <div class="py-3 mb-6 text-center theme:bg-primary-500">Home Page Custom Content</div>
  </div>
</template>
